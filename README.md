...
- Inventory/NBT picking for item rewards and item-stack icons
- Repeatable quests
- Lock or hide quests and chapters until they are unlocked
- Custom quest and chapter icons
...
- Quest minimap with pixel and visual preview modes
- Custom UI themes
- Full screen quest tablet canvas mode
- Optional JEI, EMI, and REI keybind support for item Requirements, Rewards, and recipe cards
