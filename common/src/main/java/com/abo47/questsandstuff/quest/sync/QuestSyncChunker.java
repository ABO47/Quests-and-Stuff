...
final class QuestSyncChunker {
    ...
    List<SyncChunk> fullChunks(PlayerQuestState playerState, Set<String> syncedQuestIds, boolean editorGraphVisible) {
        ...
        for (int i = 0; i < chunkIds.size(); i++) {
            ...
            payload.put(QuestSyncKeys.QUESTS, payloads.questPayload(playerState, chunkIds.get(i)));
    ...
    List<SyncChunk> deltaChunks(
        ...
        for (int i = 0; i < chunkCount; i++) {
            ...
            if (i == 0 && includeMetadata) {
                ...
                payload.put(QuestSyncKeys.GROUP_PROPS, payloads.groupPropsTagForGroups(changedGroups));
            }
            ...
            payload.put(QuestSyncKeys.REMOVED, removed);
