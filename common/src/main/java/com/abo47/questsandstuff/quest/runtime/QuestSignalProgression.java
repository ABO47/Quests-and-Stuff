...
final class QuestSignalProgression {
    ...
    QuestSignalProgression(QuestDefinitionStore definitionStore, QuestProgressSavedData progressData, QuestSyncService syncService, QuestPerformanceTracker performanceTracker, QuestRuntimeEngine engine) {
