...
final class DisplayCacheSyncer {
    ...
    static CompoundTag payload(Map<String, String> advancements, Map<String, String> lootTables, Map<String, String> biomes) {
        ...
        payload.put(SyncKeys.DisplayCache.ADVANCEMENTS, stringMapTag(advancements));
        payload.put(SyncKeys.DisplayCache.LOOT_TABLES, stringMapTag(lootTables));
        payload.put(SyncKeys.DisplayCache.BIOMES, stringMapTag(biomes));
        return payload;
    }
