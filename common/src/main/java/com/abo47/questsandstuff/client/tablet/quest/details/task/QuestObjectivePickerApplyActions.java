...
final class QuestObjectivePickerApplyActions {
    ...
    static void applyRecipePick(Player player, TabletUiState state, String recipe) {
        ...
        JsonObject json = TaskJsonFactory.simpleTask(parsed.entryId(), parsed.type(), recipeTarget, QuestObjectiveIconActions.recipeIcon(recipeTarget));
        EditorQuestCommandClient.putQuestTaskJson(player, parsed.questId(), json.toString());
        state.questDetails.questDetailsPickTarget = "";
    ...
    static void applyBlockPick(Player player, TabletUiState state, String block) {
        ...
        JsonObject json = TaskJsonFactory.simpleTask(parsed.entryId(), parsed.type(), blockId, QuestObjectiveIconActions.blockIcon(blockId));
        EditorQuestCommandClient.putQuestTaskJson(player, parsed.questId(), json.toString());
        state.questDetails.questDetailsPickTarget = "";
    ...
    static void applyStatPick(Player player, TabletUiState state, String stat) {
        ...
        JsonObject json = TaskJsonFactory.simpleTask(parsed.entryId(), parsed.type(), statTarget, QuestObjectiveIconActions.statIcon(statTarget));
        EditorQuestCommandClient.putQuestTaskJson(player, parsed.questId(), json.toString());
        state.questDetails.questDetailsPickTarget = "";
