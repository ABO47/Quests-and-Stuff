...
final class QuestObjectiveDisplayText {
    ...
    static String displayName(JsonObject json, String type) {
        ...
        if ("biome".equals(path)) {
            return TabletVocabulary.text(QuestVocabulary.VISIT_TARGET, readableIdName(QuestObjectiveJsons.asString(json, "target", "")));
        }
        ...
        if ("location".equals(path)) {
            return TabletVocabulary.text(QuestVocabulary.VISIT_TARGET, readableIdName(QuestObjectiveJsons.asString(json, "dimension", "")));
        }
