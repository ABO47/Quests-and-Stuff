...
public final class QuestTaskHudDisplay {
    private QuestTaskHudDisplay() {
    }
    ...
    public static String title(CompoundTag taskTag) {
        ...
        return QuestTaskDisplayText.displayName(json, type);
    }
    ...
    public static String progressText(CompoundTag taskTag) {
        ...
        String type = taskTag.getString("type");
        JsonObject json = jsonWithType(taskTag, type);
        if (QuestTaskDisplayText.usesAmountField(json, true)) {
            int amount = QuestTaskDisplayText.amount(json);
    ...
    public static String icon(CompoundTag taskTag) {
        ...
        String type = taskTag.getString("type");
        return QuestTaskDisplayText.taskIcon(jsonWithType(taskTag, type));
    }
