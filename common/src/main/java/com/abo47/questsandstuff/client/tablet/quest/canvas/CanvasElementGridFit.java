...
public final class CanvasElementGridFit {
    ...
    public static CanvasExclusiveChoice fittedExclusiveChoice(CanvasExclusiveChoice ec, int grid, BoundsClamp clamp) {
        ...
        if (rotation == 0) {
            ...
            return new CanvasExclusiveChoice(ec.id(), clamped.x, clamped.y, box.width(), box.height(), ec.rotation(), ec.connectionQuestIds(), ec.prerequisiteQuestIds(), ec.background(), ec.connectionColors(), ec.connectionModes());
        }
        ...
        return new CanvasExclusiveChoice(ec.id(), clamped.x, clamped.y, fit.width(), fit.height(), ec.rotation(), ec.connectionQuestIds(), ec.prerequisiteQuestIds(), ec.background(), ec.connectionColors(), ec.connectionModes());
    }
