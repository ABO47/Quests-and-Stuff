...
final class CanvasSceneRenderer {
    private static final ResourceLocation DEFAULT_QUEST_BG = ResourceLocation.fromNamespaceAndPath("questsandstuff", "textures/gui/quest_backgrounds/default_quest_bg.png");
